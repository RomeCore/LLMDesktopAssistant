	...
	MaterialIconKind icon, IBrush color)
{
	...
	private static MaterialIconKind GetIcon(ToolBehaviour flag) => flag switch
	{
		...
		ToolBehaviour.SkillEdit => MaterialIconKind.Cards,
		ToolBehaviour.SubAgentEdit => MaterialIconKind.Robot,
		ToolBehaviour.ToolEdit => MaterialIconKind.Tools,
		ToolBehaviour.ScriptEdit => MaterialIconKind.Script,
	...
	private static IBrush GetColor(ToolBehaviour flag) => flag switch
	{
		...
		ToolBehaviour.ToolEdit => Brushes.DarkRed,
		ToolBehaviour.ScriptEdit => Brushes.DarkRed,
		...
		ToolBehaviour.SubAgentEdit => Brushes.DarkRed,
		...
		ToolBehaviour.SkillEdit => Brushes.DarkRed,
